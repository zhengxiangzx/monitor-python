...
count_sentences_path = '/opt/zhengxiang/mail_send/count_sentences.txt'
...
def load_count():
    count_dict = {}
    with smart_open(count_sentences_path, 'rb', encoding='utf-8') as fin:
        for line in fin:
...
def send_mail(data_all, count_all):
    ...
    receiver = ['guowanfeng@cyou-inc.com', 'shizhan_pt@cyou-inc.com',
                'zhaomingming@cyou-inc.com',
                'zhanghaitao@cyou-inc.com',
                'chufucun@cyou-inc.com', 'zhengxiang@cyou-inc.com', 'duanxiaolei@cyou-inc.com']
    subject = '标注系统-每天打标签数量统计--' + today
    ...
    msg['From'] = formataddr(["标注系统", sender])
    msg['Subject'] = subject
    msg['To'] = ','.join(receiver)
    msg['Cc'] = 'tianhonghan@cyou-inc.com'
